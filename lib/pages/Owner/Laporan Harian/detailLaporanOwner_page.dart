...
class DetailLaporanOwnerPage extends StatefulWidget {
  final Checkin? checkin;
  final Checkout? checkout;

  const DetailLaporanOwnerPage({super.key, this.checkin, this.checkout});

  @override
  State<DetailLaporanOwnerPage> createState() => _DetailLaporanOwnerPageState();
}

class _DetailLaporanOwnerPageState extends State<DetailLaporanOwnerPage> {
